...
const NavBar = () => {
  ...
  return (
    <nav>
      ...
      <NavLink to="/dogs/random/one">Single Random Dog</NavLink>
      <NavLink to="/dogs/random">Multiple Random Dogs</NavLink>
      <NavLink to="/dogs/breed">Single Random Dog by Breed</NavLink>
      <NavLink to="/cats/random/one">Single Random Cat</NavLink>
      <NavLink to="/cats/random">Multiple Random Cats</NavLink>
